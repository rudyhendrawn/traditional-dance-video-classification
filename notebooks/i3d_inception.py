...
from tensorflow.keras.layers import Activation, Dense, Input, BatchNormalization, Conv3D, MaxPooling3D, AveragePooling3D, \
    Dropout, Reshape, Lambda, GlobalAveragePooling3D
